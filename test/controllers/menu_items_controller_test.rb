...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { establishment_id: @menu_item.establishment_id, name: @menu_item.name, price_cents: @menu_item.price_cents } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { establishment_id: @menu_item.establishment_id, name: @menu_item.name, price_cents: @menu_item.price_cents } }
